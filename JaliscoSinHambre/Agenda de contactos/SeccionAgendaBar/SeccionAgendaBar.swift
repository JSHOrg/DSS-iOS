...
var seccionesAgenda : [String]? 

class SeccionAgendaBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    var agendaVC: AgendaContactosVC?
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if agendaVC != nil {
            agendaVC?.scrollToMenuIndex(menuIndex: indexPath.item)
        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.title.text = seccionesAgenda?[indexPath.row]
