//
//  DetellaContactosVC+Extension.swift
//  JaliscoSinHambre
//
...
extension DetalleContactosVC {
    ...
    func setupInfoContactoView(keyWindow: UIWindow) {
        
        let infoContactoFrame = CGRect(x: 0, y: 0, width: keyWindow.frame.width, height: keyWindow.frame.height)
        
        let infoContacto = InfoContactoVC(frame: infoContactoFrame)
        
        keyWindow.addSubview(infoContacto)
    }
